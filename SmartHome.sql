...
INSERT INTO ALERT (ID, TYPE, SEVERITY , STATUS, START_TS, END_TS, MESSAGE, CREATE_AT, USER_ID, HOME_ID, DEVICE_ID, ROOM_ID) VALUES (1, 'Security', 'High', 'Open', '2026-02-24 04:18:02','2026-02-24 04:18:02','Canh bao: Phat hien cua mo trai phep trong che do Night', '2026-02-24 04:18:03', 1, 1, 2, 3)
INSERT INTO ALERT (ID, TYPE, SEVERITY , STATUS, START_TS, END_TS, MESSAGE, CREATE_AT, USER_ID, HOME_ID, DEVICE_ID, ROOM_ID) VALUES (2, 'Security', 'High', 'Ack', '2026-02-24 04:10:23','2026-02-24 04:16:57','Canh bao: Thu mo khoa that bai nhieu lan', '2026-02-24 04:10:24', 1, 1, 1, 3)
INSERT INTO ALERT (ID, TYPE, SEVERITY , STATUS, START_TS, END_TS, MESSAGE, CREATE_AT, USER_ID, HOME_ID, DEVICE_ID, ROOM_ID) VALUES (3, 'System', 'Medium', 'Open', '2026-02-24 07:02:59','2026-02-24 07:03:11','Xung dot he thong: Nguoi dung bat thu cong chan vong lap tat tu dong', '2026-02-24 07:03:00', 3, 1, 3, 1)
